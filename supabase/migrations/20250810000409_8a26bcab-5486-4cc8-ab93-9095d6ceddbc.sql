...
DROP TRIGGER IF EXISTS on_deposit_approval ON transactions;
DROP TRIGGER IF EXISTS transactions_after_update_deposit ON transactions;
DROP TRIGGER IF EXISTS trg_transactions_deposit_approval ON transactions;
DROP TRIGGER IF EXISTS trg_transactions_handle_deposit_approval ON transactions;
...
-- Drop functions
DROP FUNCTION IF EXISTS handle_deposit_approval() CASCADE;
DROP FUNCTION IF EXISTS handle_bonus_transaction() CASCADE;
...
-- Create function to handle bonus transactions
